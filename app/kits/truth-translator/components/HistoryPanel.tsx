      ...
      >
        <div className="flex items-center justify-between px-6 py-5 border-b border-stone-200 bg-stone-50/50">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-xl bg-gradient-to-br from-amber-100 to-orange-100 border border-amber-200">
              <History className="w-5 h-5 text-amber-600" />
            </div>
            <div>
              <h2 className="text-lg font-bold text-stone-900">历史记录</h2>
        ...
        <div className="h-[calc(100%-140px)] overflow-y-auto bg-stone-50/30">
          {history.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-stone-400">
              ...
              <p className="text-lg font-medium text-stone-600">暂无历史记录</p>
            ...
            <div className="p-4 space-y-3">
              {history.map((record, index) => (
                <div
                  key={record.id}
                  className="group relative bg-white hover:bg-stone-50 border border-stone-200 hover:border-stone-300 rounded-2xl p-4 cursor-pointer transition-all duration-200 shadow-sm hover:shadow-md animate-fade-in-up"
